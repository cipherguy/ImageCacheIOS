...
/**
 ...
 The on-disk cache will be stored at `~/Library/Caches/com.ciphr.cache/NAME/`.
...
/**
 ...
 will default to `~/Library/Caches/com.cipher.cache/NAME/`.
 @return A new cache.
 */
...
@interface CacheContainer (UIImageAdditions)
